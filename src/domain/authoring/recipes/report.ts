...
5. One level-2 heading per section. Inside a section: a short paragraph, then the block the content actually is — a chart for a series of numbers you were given, a diagram for a process or a system you were described, a cardGrid for parallel items, a table only for a dense grid.
